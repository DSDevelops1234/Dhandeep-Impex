...
export default function HomePage() {
    ...
    return (
        <div className="flex flex-col min-h-screen ">
                        ...
                        {newArrivals.map((product) => (
                            <div key={product.id} className="bg-gray-200 rounded-lg shadow-2xl overflow-hidden">
                                ...
                                <div className="p-4">
                                    ...
                                    <Button className="w-full" variant="custom" onClick={() => addToCart(product)}>
                                        Add to Cart
                                    </Button>
                                </div>
                            </div>
            ...
            {/* Process Section */}
            <section className="py-16 bg-gray-200 text-[#1b2437] ">
                <div className="container mx-auto px-4">
            ...
            {/* Footer */}
            <footer className="bg-gray-200 text-navy-900 py-12">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            <h3 className="text-xl font-bold mb-4">DENIMHUB</h3>
                            <p className="">Premium jeans and trousers for every style.</p>
                        </div>
                        <div>
                            <h4 className="text-lg font-semibold mb-4">Quick Links</h4>
                            <ul className="space-y-2">
                                <li><Link to="/new-in" className="hover:text-black">New Arrivals</Link></li>
                                <li><Link to="/jeans" className="hover:text-black">Jeans</Link></li>
                                <li><Link to="/trousers" className="hover:text-black">Trousers</Link></li>
                                <li><Link to="/cargo" className="hover:text-black">Cargo</Link></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link to="#" className="hover:text-black">Size Guide</Link></li>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
                        <p style={{ color: 'black' }}>&copy; {new Date().getFullYear()} DENIMHUB. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
